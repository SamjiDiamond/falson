...
class Transaction extends Model implements Auditable
{
    ...
    protected $fillable = [
        'name', 'amount', 'status', 'description', 'date', 'user_name', 'ip_address', 'device_details', 'code', 'i_wallet', 'f_wallet', 'extra', 'server', 'server_response', 'ref', 'commission', 'fee', 'device_details'
    ];
