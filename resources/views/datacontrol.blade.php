            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @can('data-plans-create')
                        <a href="{{route('datanew')}}" class="btn btn-gradient-success mb-4">Create New Data Plan</a>
                    @endcan
                    ...
                    <script type="text/javascript">
                        function applyFilter() {
                            ...
                            if (server === 'ALL') {
                                url = "{{ route('dataplans', ':network') }}".replace(':network', network);
                            } else {
                                url = "{{ route('server_dataplans', [':network', ':server']) }}"
                        ...
                        function applyBulkAction() {
                            ...
                            var url = "{{ route('dataserveMultipleedit', [':network', ':type', ':status', ':server']) }}"
                                .replace(':network', network)
