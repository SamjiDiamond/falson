...
class GenerateUzobestOld extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'samji:uzobestold {--command= : <tv|data|electricity> command to execute} {--type= : <mtn|airtel|gotv|dstv> type to execute}';
