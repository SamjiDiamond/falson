...
class PinManagementController extends Controller
{
    ...
    public function resetPin(Request $request)
    {
        ...
        Mail::to($input['email'])->later(now()->addSeconds(2), new PinVerificationMail($edata, "Pin"));

        return response()->json(['success' => 1, 'message' => 'A verification code has been sent to your mail.']);
    }

    public function completeResetPasscode(Request $request)
    {
        ...
        return response()->json(['success' => 1, 'message' => 'Passcode changed successfully']);
    }
    ...
    public function resetPasscode(Request $request)
    {
        ...
        Mail::to($input['email'])->later(now()->addSeconds(2), new PinVerificationMail($edata, "Passcode"));
