<div class="pre">
    <table border="0" width="680" cellspacing="0" cellpadding="0">
                        ...
                        <td width="650">
                            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td>
                                        <p>Hello,</p>
                                        <p>To complete your registration, you just need to confirm your email address by entering the code below.</p>
                                        <p>Your verification code is</p>
                                        <p><strong>{{$edata['code']}}</strong></p>
                                        <br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                            <p>IP address: {{$edata['ip']}}</p>
                                            <p>Date & Time: {{\Carbon\Carbon::now()->format('D, M d, Y  H:i:s a T')}}</p>
                                        </div>
                                        <p>
                                            If this wasn't you, please do not share the code with anyone <br/>
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
        ...
        <tr>
            <td align="center">
                <br />
                This mail was sent with ❤ from {{env('APP_NAME')}} to {{$edata['email']}}
                <br />
